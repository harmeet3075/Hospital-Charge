...
public class HealthFragment extends Fragment {
    ...
    {
        View view=layoutInflater.inflate(R.layout.layout_health_frag,viewGroup,false);
        NavigationActivity navigationActivity=(NavigationActivity)getActivity();
        navigationActivity.setHeading("HEALTHCARE");
    ...
    private void home()
    {
        String parameters="data[Page][title]=healthcare-providers"+"&api_key=bf45c093e542f057c123ae7d6";
    ...
    private class HomeTask extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... params) {
           /* String parameters=params[0];
            ...
            nameValuePair.add(new BasicNameValuePair("data[Page][title]", "healthcare-providers"));
