...
public class DiagnosesHospitals implements Parcelable {
    ...
    public String hospital_id, discharges, charge_amt, total_amt, medicare_amt;
    ...
    public static final Creator<DiagnosesHospitals> CREATOR = new Creator<DiagnosesHospitals>() {
